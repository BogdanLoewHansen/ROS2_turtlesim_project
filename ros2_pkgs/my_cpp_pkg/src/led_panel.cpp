...
public:
    ...
    {   
        ...
        led_states_publisher_ = this->create_publisher<my_robot_interfaces::msg::LedStateArray>("led_states", 10);
...
private:
                        ...
                        const my_robot_interfaces::srv::SetLed::Response::SharedPtr response)
    {
        ...
        if (led_number > (int)led_states_.size() || led_number <= 0){
