...
class TurtleSpawnerNode(Node):
    ...
    def __init__(self):
        ...
        self.alive_turtles_ = []
        self.alive_turtles_publihser_ = self.create_publisher(
        ...
        self.get_logger().info("Turtle spawner/killer has been started")
    ...
    def publish_alive_turtles(self):
        ...
        self.alive_turtles_publihser_.publish(msg)
